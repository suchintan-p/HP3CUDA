...
public:
    ...
    void profile(const float *train_X, float *train_Y, int transfer_every_layer, int pre_allocate_gpu);
...
private:
    void profile_on_batch(const float *batch_X, float *batch_Y, int transfer_every_layer, int pre_allocate_gpu);
