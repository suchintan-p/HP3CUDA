...
void Model::profile(const float *train_X, float *train_Y, int transfer_every_layer)
{
    ...
    profile_on_batch(train_X, train_Y, transfer_every_layer);
...
void Model::profile_on_batch(const float *batch_X, float *batch_Y, int transfer_every_layer)
{
